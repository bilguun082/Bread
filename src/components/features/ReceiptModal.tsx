      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="text-center pb-2 border-b border-dashed border-slate-400">
            <h4 className="text-base font-black tracking-wider">ГАРЫН САЙН ТАЛХ</h4>
            <p className="text-[10px] text-slate-600">Хөрөнгөний талхны хүргэлт</p>
          </div>
          ...
          <div className="py-2 border-b border-dashed border-slate-400">
            <div className="flex justify-between font-bold text-[11px] pb-1 border-b border-slate-200">
              <span className="w-2/5">Бараа</span>
          ...
          <div className="py-2 border-b border-dashed border-slate-400 space-y-1 text-[11px]">
            ...
            <div className="flex justify-between font-bold">
              ...
              <span>{formatTugrik(receiptData.todayDue)}</span>
            </div>
          ...
          <div className="py-2 border-b border-dashed border-slate-400 space-y-0.5 text-[11px]">
            <div className="font-bold">Төлбөр төлсөн:</div>
